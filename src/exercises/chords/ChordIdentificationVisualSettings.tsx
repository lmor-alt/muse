...
import type { ExerciseSettingsProps, ChordIdentificationVisualSettings as Settings, ChordQuality } from '../../types';
...
export const ChordIdentificationVisualSettings: React.FC<ExerciseSettingsProps> = ({
  settings,
  onChange,
  isPracticeMode = true,
}) => {
